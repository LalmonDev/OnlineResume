...
<style scoped>
    ...
    #index_pc_bj{width:100%;height:100%;background-image: url(../assets/logo.jpg);background-size:cover;overflow: hidden;background-position:center center;box-shadow: 0 0px 3px rgba(0,0,0,.5);text-align: center;}
