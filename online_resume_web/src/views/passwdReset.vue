        ...
        <div id="index_pc_bj">
            <Form ref="formLogin" :model="formLogin" :rules="ruleLogin">
                <div class="wrap_conter">
                    <ul>
                        <li style="list-style: none;"><h2>你好, {{userName}}</h2></li>
...
<style scoped>
    ...
    #index_pc_bj{width:100%;height:100%;background-image: url(../assets/reset.jpg);background-size:cover;overflow: hidden;background-position:center center;box-shadow: 0 0px 3px rgba(0,0,0,.5);text-align: center;}
